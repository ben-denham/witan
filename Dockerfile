...
# Install system dependencies (install these before
...
# Install ipytree so that we can install its nbextension in the image.
RUN pip install ipytree==0.2.1
RUN jupyter nbextension install --py --user ipytree
RUN jupyter nbextension enable --py --user ipytree
